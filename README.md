<h3>Traffic Analysis for ClubRunner districts — solving the multi-domain analytics challenge</h3>
...
We've put together a GTM + GA4 configuration that addresses this. <br/><br/>
